###########################################################################
## Makefile generated for Simulink model 'arduino_simulink'. 
## 
## Makefile     : arduino_simulink.mk
## Generated on : Thu Aug 13 17:15:18 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/arduino_simulink.elf
...
PRODUCT_NAME              = arduino_simulink
MAKEFILE                  = arduino_simulink.mk
MATLAB_ROOT               = S:/PROGRA~3/MATLAB/R2020a
MATLAB_BIN                = S:/PROGRA~3/MATLAB/R2020a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = S:/Documents/MATLAB/Examples/R2020a/arduinoio/moro2020
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH        = C:/Users/steph/DOCUME~1/MATLAB/R2020a/ARDUIN~1/ARDUIN~1/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/arduino_simulink.elf
...
DEFINES_ = -DMODEL=arduino_simulink -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DXCP_CUSTOM_PLATFORM -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=1 -DMW_PRESCALAR=1024 -DMW_TIMERCOUNT=62411 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=arduino_simulink -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o arduino_simulink.o arduino_simulink_data.o MW_ArduinoHWInit.o io_wrappers.o MW_PWMDriver.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/arduino_simulink_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/arduino_simulink_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/arduino_simulink_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
arduino_simulink.o : $(START_DIR)/arduino_simulink_ert_rtw/arduino_simulink.c
	$(CC) $(CFLAGS) -o "$@" "$<"


arduino_simulink_data.o : $(START_DIR)/arduino_simulink_ert_rtw/arduino_simulink_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/arduino_simulink_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
